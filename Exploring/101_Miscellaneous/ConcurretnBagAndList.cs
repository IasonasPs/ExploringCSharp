...
internal class ConcurretnBagAndList
{
    public static void bagToListMain()
    {
        ...
        //foreach (var item in cbModel._bag) { Console.WriteLine(item); }
        #endregion
        #region CBag Remove all elements
    ...
    public static ConcurrentBag<string> Empty(ref ConcurrentBag<string> bag)
    {
        int count = bag.Count;
        bool control = true;
        while (control)
        {
            ...
            //Index older versions of .net and also in .net framework 4.8
